...
var showPlayerHealth = function(playerName, playerHealth, playerHealthMultiplier) {
    var calculatedHealth = playerHealth * playerHealthMultiplier;
    console.log(playerName + " has health " + calculatedHealth);
};
